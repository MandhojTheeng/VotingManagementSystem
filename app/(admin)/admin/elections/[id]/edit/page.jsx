// app/(admin)/admin/elections/[id]/edit/page.jsx
"use client";

import { useState, useEffect, useRef } from "react";
import { useRouter, useParams } from "next/navigation";
import API from "../../../../../../lib/api";
import { ArrowLeft, Plus, Trash2, Upload, X, Users } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto p-6 lg:p-10">
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 lg:p-12 space-y-10">
            ...
            <div>
              <label className="block text-sm font-bold text-blue-950 mb-4">
